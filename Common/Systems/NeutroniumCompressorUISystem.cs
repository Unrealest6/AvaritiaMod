...
{
    public sealed class NeutroniumCompressorUISystem : ModSystem
    {
        internal NeutroniumCompressorUI? CurrentUI { get; private set; }
        private UserInterface? _userInterface;
        private Point16? _currentTilePos;
        public void ShowMyUI(NeutroniumCompressorTileEntity tileEntity)
        {
            CurrentUI = new NeutroniumCompressorUI(tileEntity);
        ...
        public override void ModifyInterfaceLayers(List<GameInterfaceLayer> layers)
        {
            ...
            if (inventoryIndex != -1)
            {
                layers.Insert(inventoryIndex, new LegacyGameInterfaceLayer(
                    "Avaritia: NeutroniumCompressorUI",
                    delegate
                    {
