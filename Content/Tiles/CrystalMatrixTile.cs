...
{
    public sealed class CrystalMatrixTile : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<CrystalMatrix>());
        }
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            Main.tile[i, j].TileFrameX = (short)(frame.X * 18 + 2 + 110 * (CrystalMatrix.AnimatedTexture?.CurrentFrameIndex ?? 0));
