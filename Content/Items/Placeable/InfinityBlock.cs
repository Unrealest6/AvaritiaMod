...
{
    public sealed class InfinityBlock : FrameItem
    {
        ...
        public override void SetDefaults()
        {
            Item.width = 16;
            Item.height = 16;
            Item.createTile = ModContent.TileType<InfinityBlockTile>();
        ...
        public override void AddRecipes()
        {
            ...
            for (int i = 0; i < 9; i++)
            {
                recipe.AddIngredient(ModContent.ItemType<InfinityIngot>());
            }
            recipe.Register();
        }
    }
